...
if (needsSeed) {
  ...
  const seed = db.transaction(() => {
    ...
    // Шаблоны рецептов по типу десерта
    const torte = [['Мука пшеничная в/с','300 г'],['Яйца куриные С0','6 шт'],['Сахар','200 г'],['Масло сливочное 82.5%','150 г'],['Сливки 33%','400 мл'],['Сливочный сыр (крем-чиз)','300 г'],['Ванильный экстракт','5 мл'],['Разрыхлитель','10 г']];
    const bento = [['Мука пшеничная в/с','100 г'],['Яйца куриные С0','2 шт'],['Сахар','80 г'],['Масло сливочное 82.5%','60 г'],['Сливочный сыр (крем-чиз)','150 г'],['Сливки 33%','100 мл'],['Красители пищевые','1 шт']];
    const macaron = [['Миндальная мука','150 г'],['Сахарная пудра','150 г'],['Яйца куриные С0','3 шт'],['Сахар','150 г'],['Красители пищевые','1 шт']];
    const candy = [['Шоколад тёмный 70%','200 г'],['Сливки 33%','100 мл'],['Масло сливочное 82.5%','30 г'],['Глюкозный сироп','20 г']];
    const cheesecake = [['Сливочный сыр (крем-чиз)','500 г'],['Сахарная пудра','100 г'],['Яйца куриные С0','3 шт'],['Сливки 33%','200 мл'],['Масло сливочное 82.5%','80 г'],['Мука пшеничная в/с','100 г'],['Ванильный экстракт','5 мл']];
    const mousse = [['Сливки 33%','300 мл'],['Шоколад белый','150 г'],['Желатин листовой','10 г'],['Сахар','60 г'],['Яйца куриные С0','2 шт']];
    const meringue = [['Яйца куриные С0','4 шт'],['Сахарная пудра','200 г'],['Лимонная кислота','3 г'],['Сливки 33%','200 мл']];
    const zefir = [['Яйца куриные С0','2 шт'],['Сахар','150 г'],['Пюре клубничное','100 г'],['Желатин листовой','8 г'],['Сахарная пудра','50 г']];
    const pirozhki = [['Мука пшеничная в/с','150 г'],['Яйца куриные С0','2 шт'],['Сахар','100 г'],['Масло сливочное 82.5%','80 г'],['Какао-порошок','20 г'],['Молоко сгущённое','50 г']];
    const tort3d = [['Мука пшеничная в/с','400 г'],['Яйца куриные С0','8 шт'],['Сахар','300 г'],['Масло сливочное 82.5%','200 г'],['Мастика готовая','500 г'],['Красители пищевые','2 шт'],['Сливочный сыр (крем-чиз)','400 г'],['Сливки 33%','300 мл']];
    const wedding = [['Мука пшеничная в/с','500 г'],['Яйца куриные С0','10 шт'],['Сахар','350 г'],['Масло сливочное 82.5%','300 г'],['Сливки 33%','500 мл'],['Сливочный сыр (крем-чиз)','500 г'],['Ванильный экстракт','10 мл'],['Разрыхлитель','15 г']];
    const napoleon = [['Мука пшеничная в/с','400 г'],['Масло сливочное 82.5%','300 г'],['Яйца куриные С0','4 шт'],['Молоко 3.2%','500 мл'],['Сахар','200 г'],['Ванильный экстракт','5 мл'],['Крахмал кукурузный','40 г']];
    const kulich = [['Мука пшеничная в/с','500 г'],['Яйца куриные С0','5 шт'],['Сахар','150 г'],['Масло сливочное 82.5%','100 г'],['Молоко 3.2%','200 мл'],['Дрожжи сухие','10 г'],['Ванильный экстракт','5 мл']];
    const tvorog = [['Творог 9%','400 г'],['Сливочный сыр (крем-чиз)','200 г'],['Сахарная пудра','80 г'],['Сливки 33%','100 мл'],['Желатин листовой','8 г'],['Ванильный экстракт','3 мл']];
    ...
    allProducts.forEach(p => {
      ...
      // Специфичные добавки
      let extras = [];
      if (n.includes('ягод') || n.includes('лукошко')) extras = [['Клубника свежая','200 г'],['Голубика свежая','100 г'],['Малина свежая','100 г']];
      else if (n.includes('клубник')) extras = [['Клубника свежая','150 г'],['Пюре клубничное','50 г']];
      else if (n.includes('малин')) extras = [['Малина свежая','150 г'],['Пюре малиновое','50 г']];
      else if (n.includes('лимон')) extras = [['Лимоны','200 г'],['Крахмал кукурузный','20 г']];
      else if (n.includes('кофейн')) extras = [['Кофе молотый','30 г']];
      else if (n.includes('шоколадн') && !n.includes('дубайск')) extras = [['Какао-порошок','30 г'],['Шоколад тёмный 70%','100 г']];
      else if (n.includes('дубайск')) extras = [['Фисташковая паста','50 г'],['Шоколад тёмный 70%','150 г']];
...
if (fillingRecipesCount === 0) {
  ...
  // Рецепты для начинок (на 100г крема)
  const fillingRecipes = {
    'snikers': [
      [ingId('Сливочный сыр (крем-чиз)'), '35г'],
      [ingId('Карамель'), '20г'],
      [ingId('Шоколад тёмный 70%'), '18г'],
      [ingId('Арахис жареный'), '15г'],
      [ingId('Масло сливочное 82.5%'), '8г'],
      [ingId('Какао-порошок'), '4г']
    ],
    'red-velvet': [
      [ingId('Сливочный сыр (крем-чиз)'), '55г'],
      [ingId('Сахарная пудра'), '25г'],
      [ingId('Сливки 33%'), '15г'],
      [ingId('Какао-порошок'), '4г'],
      [ingId('Красители пищевые'), '1г']
    ],
    'carrot': [
      [ingId('Сливочный сыр (крем-чиз)'), '50г'],
      [ingId('Творог 9%'), '20г'],
      [ingId('Сахарная пудра'), '18г'],
      [ingId('Сливки 33%'), '10г'],
      [ingId('Ванильный экстракт'), '2г']
    ],
    'berry': [
      [ingId('Сливочный сыр (крем-чиз)'), '40г'],
      [ingId('Пюре малиновое'), '25г'],
      [ingId('Пюре клубничное'), '20г'],
      [ingId('Сахарная пудра'), '12г'],
      [ingId('Желатин листовой'), '3г']
    ],
    'banana-choco': [
      [ingId('Сливочный сыр (крем-чиз)'), '35г'],
      [ingId('Бананы'), '25г'],
      [ingId('Шоколад тёмный 70%'), '18г'],
      [ingId('Молоко сгущённое'), '15г'],
      [ingId('Сливки 33%'), '5г'],
      [ingId('Какао-порошок'), '2г']
    ],
    'cherry': [
      [ingId('Сливочный сыр (крем-чиз)'), '45г'],
      [ingId('Вишня замороженная'), '30г'],
      [ingId('Сахарная пудра'), '18г'],
      [ingId('Сливки 33%'), '5г'],
      [ingId('Лимонная кислота'), '2г']
    ],
    'tropical': [
      [ingId('Сливочный сыр (крем-чиз)'), '40г'],
      [ingId('Пюре манго'), '25г'],
      [ingId('Пюре маракуйя'), '20г'],
      [ingId('Кокосовая стружка'), '10г'],
      [ingId('Сахарная пудра'), '3г'],
      [ingId('Желатин листовой'), '2г']
    ],
    'tiramisu': [
      [ingId('Сливочный сыр (крем-чиз)'), '45г'],
      [ingId('Сливки 33%'), '25г'],
      [ingId('Молоко сгущённое'), '15г'],
      [ingId('Какао-порошок'), '10г'],
      [ingId('Кофе молотый'), '4г'],
      [ingId('Ликёр Амаретто'), '1г']
    ]
  };
